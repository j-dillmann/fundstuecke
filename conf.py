...
BLOG_AUTHOR = "Jennifer Dillmann"  # (translatable)
BLOG_TITLE = "Fundstuecke"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://fundstuecke.blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://fundstuecke.blog/"
BLOG_EMAIL = "j.dillmann@posteo.de"
BLOG_DESCRIPTION = "Jennifers Blog - Ein Schreibsammelsorium"  # (translatable)
